...
class EventSearch extends Event
{
    ...
    {
        $query = Event::find();
        $query->leftJoin('event_translation', 'event_translation.event_id = event.id');
        $query->leftJoin('content', 'content.id = event.content_id');
        ...
        $query->groupBy(['event.id', 'event_translation.title', 'content.priority', 'content.hidden', 'content.featured', 'content.published', 'content.imported', 'content.archive', 'heritage_translation.short_name']);
        ...
        $dataProvider->sort->attributes['title'] = [
			'asc' => ['event_translation.title' => SORT_ASC],
			'desc' => ['event_translation.title' => SORT_DESC],
		];
