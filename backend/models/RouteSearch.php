...
class RouteSearch extends Route
{
    ...
    public function search($params)
    {
        ...
        $query->groupBy(['route.id', 'route_translation.title', 'content.priority', 'content.hidden', 'content.featured', 'content.published', 'content.imported', 'heritage_translation.short_name']);
