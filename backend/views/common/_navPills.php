...
<ul class="nav nav-tabs main-nav-tabs">
	...
	<li class="nav-tab <?= ($active == 3) ? 'active' : ''; ?>"><?= Html::a('<span class="glyphicon glyphicon-list-alt"></span> '. Yii::t('app', 'Profile'), Yii::$app->urlManager->createUrl(['profile-item/index', 'id' => $model->id])) ?></li>
</ul>