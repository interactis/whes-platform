    ...
    <div class="row">
    	<div class="col-md-10 col-lg-8">
			...
			<?= $this->render('/common/_relationsForm', [
				...
				'childContentHint' => 'Use this to connect other routes as stages (child routes) to this route. Please mind the correct order of the child routes.'
			]) ?>
