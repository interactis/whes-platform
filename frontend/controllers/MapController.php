...
{   
	...
	private function _getTranslations()
    {
    	return '{
			...
			"heritagePerimeter": "'. Yii::t('app', 'Perimeter of World Heritage properties') .'",
			"bufferZone": "'. Yii::t('app', 'Buffer zone of World Heritage properties') .'",
			"biospherePerimeter": "'. Yii::t('app', 'Perimeter of Biosphere reserves') .'",
